...
public class MedicalCard {
	...
	public String toString() {
		return "MedicalCard [id=" + id + ", patient=" + patient + ", doctor=" + doctor + 
				", date=" + date + ", clinicName=" + clinicName	+ ", hoursAfterAccident=" 
				+ hoursAfterAccident + ", hospitalizedInPlannedOrder=" + hospitalizedInPlannedOrder 
				+ ", hospitalizationDiagnosis=" + hospitalizationDiagnosis + ", facilityDiagnosis=" 
				+ facilityDiagnosis + ", clinicalDiagnosis=" + clinicalDiagnosis + "]";
	}
